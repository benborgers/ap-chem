...
Hund's rule dictates that that orbitals must all be filled with one electron before a second electron is added. In other words, the electrons don't pair up until they have to. 
...
![Periodic table with electron configuration areas overlayed](/assets/electron-configuration-table.png)
...
But `Fe` with charge `3+` (three *less* electrons, since electrons are negative charge) is: 
