...
For example, in <InlineMath text="\text{PO}_4 \, ^\text{3-}" /> O's oxidation number is -2. Since the overall charge of the molecule should 3-, the charge of P is +5. Therefore, S should give away 5 electrons and will have 5 covalent bonds. 
